...
namespace Game.Building
{
    ...
    {
        [SerializeField]
        private BuildingStatsModel _buildingStateModel;
        ...
        private void DrawCircleBorder()
        {
            ...
            {
                float x = Mathf.Cos(angle) * _buildingStateModel.EffectArea;
                float y = Mathf.Sin(angle) * _buildingStateModel.EffectArea;
        ...
        private void DrawCircleFill()
        {
            ...
            {
                vertices[i] = new Vector3(Mathf.Cos(angle) * _buildingStateModel.EffectArea, Mathf.Sin(angle) * _buildingStateModel.EffectArea, 0);
                angle += 2 * Mathf.PI / segments;
            }
